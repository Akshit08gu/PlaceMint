...
const Navbar = () => {
  ...
  return (
    <div className="bg-white">
      <div className="flex items-center justify-between px-8 mx-auto max-w-7xl h-16">
        <div>
          <h1 className="text-2xl font-bold">
            Place<span className="text-[#F83002]">mint</span>
          </h1>
        </div>
          ...
          {!user ? (
            ...
            <div className="relative z-50">
              <Popover>
                ...
                <PopoverContent
                  className="w-80 p-4 z-[9999] bg-white border shadow-lg"
                  align="end"
                  sideOffset={5}
                >
